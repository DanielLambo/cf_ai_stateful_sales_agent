/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9a16cfe44e68233ae92f0ee386206d52)
// Runtime types generated with workerd@1.20260114.0 2025-09-27 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SalesAgent";
	}
	interface Env {
		SALES_AGENT: DurableObjectNamespace<import("./src/index").SalesAgent>;
		AI: Ai;
		FINALIZE_CALL: Workflow<Parameters<import("./src/index").FinalizeCallWorkflow['run']>[0]['payload']>;
	}
}
